...
/**
 * Thrown by {@link com.kjhxtc.internal.apache.xml.security.signature.SignedInfo#verify()} when
 * testing the signature fails because of uninitialized
 * {@link com.kjhxtc.internal.apache.xml.security.signature.Reference}s.
 *
...
public class MissingResourceFailureException extends XMLSignatureException {
    ...
    /**
     * used to set the uninitialized {@link com.kjhxtc.internal.apache.xml.security.signature.Reference}
     *
    ...
    /**
     * used to get the uninitialized {@link com.kjhxtc.internal.apache.xml.security.signature.Reference}
     *
     * This allows to supply the correct {@link com.kjhxtc.internal.apache.xml.security.signature.XMLSignatureInput}
     * to the {@link com.kjhxtc.internal.apache.xml.security.signature.Reference} to try again verification.
     *
