...
import com.kjhxtc.internal.apache.jcp.xml.dsig.internal.DigesterOutputStream;
    ...
    */
    private static boolean useC14N11 =
        AccessController.doPrivileged((PrivilegedAction<Boolean>)
            () -> Boolean.getBoolean("com.sun.com.kjhxtc.internal.apache.xml.internal.security.useC14N11"));
        ...
        throws XMLSignatureException
    {
        ...
        try (OutputStream os = new UnsyncBufferedOutputStream(dos)) { //NOPMD
                ...
                if (context instanceof XMLSignContext) {
                    if (!c14n11) {
                        Boolean prop = (Boolean)context.getProperty
                            ("com.kjhxtc.internal.apache.xml.security.useC14N11");
            ...
            return dos.getDigestValue();
                ...
                | IOException | com.kjhxtc.internal.apache.xml.security.c14n.CanonicalizationException e) {
