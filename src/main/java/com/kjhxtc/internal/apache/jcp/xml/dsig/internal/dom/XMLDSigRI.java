        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() {
            ...
            public Void run() {
                ...
                putService(new ProviderService(p, "XMLSignatureFactory",
                    "DOM", "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMXMLSignatureFactory"));

                putService(new ProviderService(p, "KeyInfoFactory",
                    "DOM", "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMKeyInfoFactory"));


                // Inclusive C14N
                putService(new ProviderService(p, "TransformService",
                    CanonicalizationMethod.INCLUSIVE,
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMCanonicalXMLC14NMethod",
                ...
                putService(new ProviderService(p, "TransformService",
                    ...
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMCanonicalXMLC14N11Method",
                    null, MECH_TYPE));
                ...
                putService(new ProviderService(p, "TransformService",
                    ...
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMExcC14NMethod",
                ...
                putService(new ProviderService(p, "TransformService",
                    Transform.BASE64,
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMBase64Transform",
                    new String[] {"BASE64"}, MECH_TYPE));

                // Enveloped Transform
                putService(new ProviderService(p, "TransformService",
                    Transform.ENVELOPED,
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMEnvelopedTransform",
                    new String[] {"ENVELOPED"}, MECH_TYPE));

                // XPath2 Transform
                putService(new ProviderService(p, "TransformService",
                    Transform.XPATH2,
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMXPathFilter2Transform",
                    new String[] {"XPATH2"}, MECH_TYPE));

                // XPath Transform
                putService(new ProviderService(p, "TransformService",
                    Transform.XPATH,
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMXPathTransform",
                    new String[] {"XPATH"}, MECH_TYPE));

                // XSLT Transform
                putService(new ProviderService(p, "TransformService",
                    Transform.XSLT,
                    "com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMXSLTTransform",
