...
import com.kjhxtc.internal.apache.jcp.xml.dsig.internal.dom.DOMSignedInfo;
...
public class JSRForbiddenRefCountTest {
    ...
    public void testReferenceCount() throws Exception {
        ...
        context.setProperty("com.kjhxtc.internal.apache.jcp.xml.dsig.secureValidation", Boolean.FALSE);
        new DOMSignedInfo(signedInfoElement, context, null);
    }
