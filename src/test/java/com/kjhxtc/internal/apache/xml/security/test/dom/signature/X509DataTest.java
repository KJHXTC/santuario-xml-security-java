...
public class X509DataTest {
    ...
    public void testAddX509SubjectName() throws Exception {
        ...
        com.kjhxtc.internal.apache.xml.security.keys.KeyInfo ki = sig.getKeyInfo();
    ...
    private KeyStore getKeyStore() throws Exception {
        ...
        String keystoreFile = "src/test/resources/com/kjhxtc/internal/apache./xml/security/samples/input/keystore.jks";
