...
public class CreateExclC14nInteropValues {
    ...
    public static void main(String[] unused) throws Exception {
        ...
        String directory = "data/com/kjhxtc/internal/apache./xml/security/c14n/outExcl/";
...

        {
            ...
            xmlSignature.addDocument("#" + id, tf);
            // xmlSignature.addDocument("#" + id, tf, com.kjhxtc.internal.apache.xml.security.algorithms.MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA1, "ref13c", null);
        }
