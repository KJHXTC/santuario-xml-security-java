 ...
 * under the License.
 */
package com.kjhxtc.internal.apache.xml.security.test.dom.encryption;
...
import com.kjhxtc.internal.apache.xml.security.encryption.CipherData;
...
import com.kjhxtc.internal.apache.xml.security.encryption.EncryptionMethod;
import com.kjhxtc.internal.apache.xml.security.encryption.EncryptionProperties;
import com.kjhxtc.internal.apache.xml.security.encryption.EncryptionProperty;
...
import com.kjhxtc.internal.apache.xml.security.transforms.params.XPathContainer;
import com.kjhxtc.internal.apache.xml.security.utils.EncryptionConstants;
...
public class XMLCipherTest {
    ...
    public XMLCipherTest() throws Exception {
        ...
        documentName = System.getProperty("com.kjhxtc.internal.apache.xml.enc.test.doc",
                                          basedir + "/pom.xml");
        elementName = System.getProperty("com.kjhxtc.internal.apache.xml.enc.test.elem", "project");
        elementIndex = System.getProperty("com.kjhxtc.internal.apache.xml.enc.test.idx", "0");
    ...
    public void testSameDocumentCipherReference() throws Exception {
        ...
        if (haveISOPadding) {
            ...
            com.kjhxtc.internal.apache.xml.security.encryption.Transforms xencTransforms =
                cipher.createTransforms(d);
            ed.getCipherData().getCipherReference().setTransforms(xencTransforms);
            com.kjhxtc.internal.apache.xml.security.transforms.Transforms dsTransforms =
            ...
            dsTransforms.addTransform(
                com.kjhxtc.internal.apache.xml.security.transforms.Transforms.TRANSFORM_XPATH,
                xpc.getElementPlusReturns()
            );

            // Add a Base64 Transforms
            dsTransforms.addTransform(
                com.kjhxtc.internal.apache.xml.security.transforms.Transforms.TRANSFORM_BASE64_DECODE
            );
    ...
    public void testEncryptedKeyWithRecipient() throws Exception {
        String filename =
            "src/test/resources/com/kjhxtc/internal/apache./xml/security/encryption/encryptedKey.xml";
