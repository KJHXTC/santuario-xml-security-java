 ...
 * under the License.
 */
package com.kjhxtc.internal.apache.xml.security.test.dom.utils.resolver;
...
public class OfflineResolver extends ResourceResolverSpi {
    ...
    static {
        ...
        OfflineResolver.register(
            ...
            basedir + "src/test/resources/com/kjhxtc/internal/apache./xml/security/temp/nuehomepage", "text/html"
        );
        OfflineResolver.register(
            "http://www.nue.et-inf.uni-siegen.de/~geuer-pollmann/id2.xml",
            basedir + "src/test/resources/com/kjhxtc/internal/apache./xml/security/temp/id2.xml", "text/xml"
        );
        OfflineResolver.register(
