...
public class InvalidKeyTest {
    ...
    public void test() throws Exception {
        ...
        try (FileInputStream input = new FileInputStream(
            resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/samples/input/truststore.jks"))) {
    ...
    private void validate(PublicKey pk) throws Exception {
        File file = resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/samples/input/test-assertion.xml");
