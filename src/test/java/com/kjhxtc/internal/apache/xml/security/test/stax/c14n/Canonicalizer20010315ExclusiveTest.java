...
import com.kjhxtc.internal.apache.xml.security.stax.impl.transformer.canonicalizer.Canonicalizer20010315_ExclOmitCommentsTransformer;
import com.kjhxtc.internal.apache.xml.security.stax.impl.transformer.canonicalizer.Canonicalizer20010315_ExclWithCommentsTransformer;
...
public class Canonicalizer20010315ExclusiveTest {
    ...
    public void test221excl() throws Exception {
        ...
        byte[] reference =
            getBytesFromResource(this.getClass().getClassLoader().getResource(
                "com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_c14nized_exclusive.xml"));
    ...
    public void test24excl() throws Exception {
        ...
        canonicalize(c,
                this.getClass().getClassLoader().getResourceAsStream(
                        "com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_4.xml"),
                new QName("http://example.net", "elem2")
        );

        byte[] reference =
            getBytesFromResource(this.getClass().getClassLoader().getResource(
                "com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_4_c14nized.xml"));
        boolean equals = java.security.MessageDigest.isEqual(reference, baos.toByteArray());
    ...
    public void testComplexDocexcl() throws Exception {
        ...
        byte[] reference =
            getBytesFromResource(this.getClass().getClassLoader().getResource(
                "com/kjhxtc/internal/apache./xml/security/c14n/inExcl/plain-soap-c14nized.xml"));
        boolean equals = java.security.MessageDigest.isEqual(reference, baos.toByteArray());
