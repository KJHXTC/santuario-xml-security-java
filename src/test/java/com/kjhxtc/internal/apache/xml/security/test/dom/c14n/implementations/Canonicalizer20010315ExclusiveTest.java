...
import com.kjhxtc.internal.apache.xml.security.c14n.implementations.Canonicalizer20010315Excl;
import com.kjhxtc.internal.apache.xml.security.c14n.implementations.Canonicalizer20010315ExclOmitComments;
import com.kjhxtc.internal.apache.xml.security.c14n.implementations.Canonicalizer20010315ExclWithComments;
import com.kjhxtc.internal.apache.xml.security.c14n.implementations.Canonicalizer20010315WithComments;
...
import static com.kjhxtc.internal.apache.xml.security.test.XmlSecTestEnvironment.resolvePath;
...
public class Canonicalizer20010315ExclusiveTest {
    ...
    public void test221() throws Exception {
        Document doc = XMLUtils
            .read(resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_1.xml"), false);
        ...
        byte[] reference = Files.readAllBytes(
            resolvePath("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_1_c14nized.xml"));
    ...
    public void test222() throws Exception {
        Document doc = XMLUtils
            .read(resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_2.xml"), false);
        Node root = doc.getElementsByTagNameNS("http://example.net", "elem2").item(0);
        Canonicalizer20010315 c = new Canonicalizer20010315WithComments();
        byte[] reference = Files.readAllBytes(
            resolvePath("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_2_c14nized.xml"));
        try (ByteArrayOutputStream writer = new ByteArrayOutputStream()) {
            c.engineCanonicalizeSubTree(root, writer);
            boolean equals = java.security.MessageDigest.isEqual(reference, writer.toByteArray());
    ...
    public void test221excl() throws Exception {
        ...
        byte[] reference = Files.readAllBytes(
            resolvePath("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_c14nized_exclusive.xml"));
        try (ByteArrayOutputStream writer = new ByteArrayOutputStream()) {
            c.engineCanonicalizeSubTree(root, writer);
            boolean equals = java.security.MessageDigest.isEqual(reference, writer.toByteArray());
    ...
    public void test223excl() throws Exception {
        Document doc = XMLUtils
            .read(resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_3.xml"), false);
        ...
        Canonicalizer20010315Excl c = new Canonicalizer20010315ExclWithComments();
        byte[] reference = Files.readAllBytes(
            resolvePath("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_2_3_c14nized_exclusive.xml"));
        try (ByteArrayOutputStream writer = new ByteArrayOutputStream()) {
    ...
    public void test24excl() throws Exception {
        Document doc = XMLUtils
            .read(resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_4.xml"), false);
        Node root =
            doc.getElementsByTagNameNS("http://example.net", "elem2").item(0);
        Canonicalizer20010315Excl c = new Canonicalizer20010315ExclWithComments();
        byte[] reference = Files.readAllBytes(
            resolvePath("src/test/resources/com/kjhxtc/internal/apache./xml/security/c14n/inExcl/example2_4_c14nized.xml"));
        try (ByteArrayOutputStream writer = new ByteArrayOutputStream()) {
            c.engineCanonicalizeSubTree(root, writer);
            boolean equals = java.security.MessageDigest.isEqual(reference, writer.toByteArray());
