...
public class ECDSASignatureTest {
    ...
    private static final String ECDSA_JKS =
        "src/test/resources/com/kjhxtc/internal/apache./xml/security/samples/input/ecdsa.jks";
    ...
    public void testTwo() throws Exception {
        File file = resolveFile("src/test/resources/com/kjhxtc/internal/apache./xml/security/samples/input/ecdsaSignature.xml");
