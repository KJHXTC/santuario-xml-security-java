...
import com.kjhxtc.internal.apache.xml.security.test.javax.xml.crypto.dsig.EdDSATestAbstract;
...
public class EDDSASignatureTest extends EdDSATestAbstract {
    static {
        if (!com.kjhxtc.internal.apache.xml.security.Init.isInitialized()) {
    ...
    public void testEd22519VerifyXML() throws Exception {
        ...
        try (InputStream xmlSignatureExample
                     = EDDSASignatureTest.class.getResourceAsStream("/com/kjhxtc/internal/apache./xml/security/samples/input/eddsaEd25519Signature.xml")) {
    ...
    public void testEd448VerifyXML() throws Exception {
        ...
        try (InputStream xmlSignatureExample
                     = EDDSASignatureTest.class.getResourceAsStream("/com/kjhxtc/internal/apache./xml/security/samples/input/eddsaEd448Signature.xml")) {
            doVerify(xmlSignatureExample);
        }
    }
 ...
 * ("src/test/resources/com/kjhxtc/internal/apache./xml/security/samples/input/eddsa.p12").
