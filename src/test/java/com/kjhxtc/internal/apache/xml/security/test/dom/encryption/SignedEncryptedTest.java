...
import com.kjhxtc.internal.apache.xml.security.encryption.DocumentSerializer;
import com.kjhxtc.internal.apache.xml.security.encryption.TransformSerializer;
    ...
    public void decryptUsingXalanTransformer() throws Exception {
        try {
            Class<?> tf = getClass().getClassLoader().loadClass(
                    "com.kjhxtc.internal.apache.xalan.processor.TransformerFactoryImpl");
            secureAndVerify((TransformerFactory) tf.newInstance(), false);
        } catch (ClassNotFoundException e) {
            System.out.println(
                    "com.kjhxtc.internal.apache.xalan.processor.TransformerFactoryImpl not found, skipping test");
        }
    }
